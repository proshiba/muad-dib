...
MUAD'DIB maintains evasive samples to validate scanner robustness (83 samples, 98.8% ADR):
- `datasets/adversarial/` -- 43 samples with evasion techniques (encoding, splitting, indirection)
