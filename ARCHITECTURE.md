...
**Rules & playbooks:** Threat types map to rules in `src/rules/index.js` (176 rules: 171 RULES + 5 PARANOID, MITRE ATT&CK mapped) and remediation text in `src/response/playbooks.js`. Both keyed by threat `type` string.
